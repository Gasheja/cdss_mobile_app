...
class CDSSApp extends StatelessWidget {
  @override
...
class SignUpScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Sign Up to CDSS')),
      body: Padding(
        padding: const EdgeInsets.all(16.0),
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
      ...
      body: ListView(
        ...
        children: [
          ListTile(
            ...
            title: Text('support@cdss.com'),
          ),
          ListTile(
            leading: Icon(Icons.phone, color: Colors.green),
            title: Text('+250785686334'),
          ),
          ListTile(
            leading: Icon(Icons.location_on, color: Colors.orange),
            title: Text('123 cdss Street, Bunagana City'),
          ),
          SizedBox(height: 16),
          TextField(
            decoration: InputDecoration(
